                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="/{{ request()->segment(1) }}/paket" method="POST" class="mb-5 text-dark" enctype="multipart/form-data" style>
                                @csrf
                                <div class="mb-3">
                                      ...
                                      <div class="mb-3">
                                        ...
                                        <select class="form-select form-control col-8 form-select mb-3" aria-label=".form-select example" id="jenis" name="jenis" required autofocus value="{{ old('jenis') }}">
