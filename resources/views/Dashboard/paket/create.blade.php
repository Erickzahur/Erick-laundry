    ...
    <div class="modal-content">
        ...
        <div class="mb-3">
                <label for="id_outlet" class="form-label">Outlet</label>
                  <select class="form-select form-control form-select mb-3" aria-label=".form-select example" id="outlet" name="id_outlet">
              ...
              <div class="mb-3">
                ...
                <select class="form-select form-control form-select mb-3" aria-label=".form-select example" id="jenis" name="jenis" required autofocus value="{{ old('jenis') }}">
