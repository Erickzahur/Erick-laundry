...
@section('content')
                     ...
                     <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                        ...
                        @include('dashboard.member.create')
                            ...
                            <div>
                                {{-- <table id="tb-member" class="table table-striped table-md">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <!-- Button trigger modal -->
                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#staticBackdrop{{ $member->id }}">
                                                Edit
                                            </button>
                                ...
                                <table id="order-listing" class="table table-striped jambo_table bulk_action">
                                    <thead>
                                        <tr>
                                            <th scope="col">No</th>
                                            <th scope="col">Nama</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <!-- Button trigger modal -->
                                            <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#staticBackdrop{{ $member->id }}">
                                                Edit
                                            </button>
      ...
      <!-- /page content -->
      @include('dashboard.member.import')
      @push('script')
    <script>
        $(function(){
        //Data Table
