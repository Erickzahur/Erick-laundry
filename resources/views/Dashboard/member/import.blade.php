<div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel"  aria-hidden="true">
	<div class="modal-dialog">
		 <form action="{{ url(request()->segment(1).'/member/import') }}" method="POST" enctype="multipart/form-data"
			  id="import-form">
			  @csrf
					...
					<div class="modal-body">
						 <div class="d-none align-items-center justify-content-between bg-white p-2 shadow-md mb-3"
							  ...
							  <div class="d-flex align-items-center">
									<div class="h1 p-3 mb-0"><i class="fa fa-file-excel-o"></i></div>
									<div>
						 ...
						 <div class="text-center py-5" id="select-import-file">
							  ...
							  {{-- <div>Klik <a href="/a/template/member">disini</a> untuk
									mengunduh
									template</div> --}}
						 </div>
						 <input type="file" class="custom-file-input" id="file-import" name="file2" hidden>
						 <button class="btn btn-primary w-100"><i class="fa fa-download mr-2"></i>Import data</button>
					</div>
			  </div>
		 </form>
	</div>
