            ...
            <div class="modal-body">
                <form action="{{ url('dashboard/member/'.$member->id) }}" method="POST" class="mb-5" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select form-control form-select mb-3" aria-label=".form-select example" id="jenis_kelamin" name="jenis_kelamin" required autofocus value="{{ old('jenis_kelamin', $member->jenis_kelamin) }}">
