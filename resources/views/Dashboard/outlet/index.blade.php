                  ...
                  @endif
                     ...
                     <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                        ...
                        @include('dashboard.outlet.create')
                            ...
                            <div>
                                <table id="tb-outlet" class="table table-striped table-md  jambo_table bulk_action">
                                    <thead>
                                      <tr>
                                        <th scope="col">No</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <!-- Button trigger modal -->
                                            <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#staticBackdrop{{ $o->id }}">
                                                Edit
                                            </button>
